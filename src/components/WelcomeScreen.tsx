...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onStart }) => {
  ...
  const [selectedMethod, setSelectedMethod] = useState<'qr' | 'nfc'>('qr');
           ...
           <div className="relative animate-fade-in-down">
              <h1 className="relative text-4xl font-black text-white italic tracking-tighter uppercase transform -skew-x-12 flex items-center shadow-2xl drop-shadow-lg">
                ...
                <div className="relative mx-0.5">
                   <Zap size={40} className="text-amber-500 fill-amber-500 drop-shadow-[0_0_20px_rgba(245,158,11,0.6)]" strokeWidth={0} />
                   <Zap size={40} className="absolute inset-0 text-white mix-blend-overlay" strokeWidth={1}/>
                </div>
